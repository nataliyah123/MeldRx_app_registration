...
import { IconCalendarEvent, IconFlame, IconSettings, IconId, IconVaccine, IconUsersGroup, IconHeartbeat, IconMicroscope, IconArchive,IconCheckupList, IconVirus, IconPlant } from '@tabler/icons-react';
...
export default function AppNavbar({ closeNavbar }: AppNavbarProps): JSX.Element {
  ...
  const patientDataPages: IMenuItem[] = [
    ...
    { display: "Medication Reconciliation Report",     href: "/patient-sphere/patient/medication-reconciliation-report",   icon: <IconCheckupList className={classes.linkIcon} /> },
