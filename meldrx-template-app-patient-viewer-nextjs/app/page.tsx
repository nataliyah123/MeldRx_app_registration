...
export default function Page() {
  ...
  return (
    <>
      ...
      <main className={`${styles.main} bg-cover bg-center bg-no-repeat`} style={{ backgroundImage: "url('/images/main_iimg.png')" , minHeight: "100vh" }}>
              ...
              {launchOptions.map((launchConfiguration: IMeldRxLaunchData, index: number) => {
                  return (
                    <LaunchButton
                      ...
                      label="Launch Medication Reconciliation Report"
                      color="green"
